...
import com.example.studysmart.presentation.components.SubjectListBottomFeed
...
private fun SessionScreen(
    ...
    // related subject drop down bottom feed
    SubjectListBottomFeed(
        ...
        onSubjectClicked = { subject ->
            scope.launch{
                sheetState.hide()    // is subject selected, hide bottom sheet
            }.invokeOnCompletion {
            ...
            item{
                ButtonSection(
                    modifier = Modifier
                        ...
                        .padding(12.dp),
                    startButtonClick = {
                        // if related subject selected only then start timer
